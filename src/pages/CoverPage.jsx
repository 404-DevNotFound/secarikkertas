...
export default function CoverPage({ onOpen }) {
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute bottom-6 sm:bottom-4 left-1/2 -translate-x-1/2 z-10 font-mono text-[8px] sm:text-[10px] tracking-[0.08em] sm:tracking-[0.15em] uppercase text-center leading-relaxed max-w-[230px] sm:max-w-none px-4"
