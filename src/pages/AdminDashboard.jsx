...
export default function AdminDashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-6 py-6 sm:py-12">
      {/* "Meja" di balik buku besar, senada dengan HomePage/Dasbor/Editor */}
      <div className="bg-naskah-surface rounded-lg p-2 sm:p-6">
        <div className="bg-naskah-bg rounded-md shadow-[0_18px_45px_rgba(28,28,19,0.22)] p-6 sm:p-10 md:p-12">
